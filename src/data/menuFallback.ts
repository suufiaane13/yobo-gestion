...
export const MENU_ITEMS: Record<MenuFallbackCategory, MenuFallbackItem[]> = {
  ...
  panini: [
    ...
    { emoji: '🧀', name: '4 Fromages', sizes: { S: 25 } },
    { emoji: '🥪', name: 'Mixte', sizes: { S: 27 } },
  ...
  sandwichs: [
    { emoji: '🥖', name: 'Hollandais', sizes: { S: 12 } },
    { emoji: '🍓', name: 'Hollandais Avec fruits', sizes: { S: 15 } },
  ...
  pizza: [
    { emoji: '🍕', name: 'Margherita', sizes: { P: 25, M: 35, G: 50 } },
    { emoji: '🍕', name: 'Viande Hachée', sizes: { P: 30, M: 45, G: 60 } },
    { emoji: '🍕', name: 'Poulet', sizes: { P: 30, M: 45, G: 60 } },
    { emoji: '🍕', name: 'Dinde', sizes: { P: 30, M: 45, G: 60 } },
    { emoji: '🍕', name: 'Dinde Fumée', sizes: { P: 35, M: 45, G: 60 } },
    { emoji: '🍕', name: 'Thon', sizes: { P: 30, M: 45, G: 60 } },
    { emoji: '🦐', name: 'Fruits de Mer', sizes: { P: 40, M: 55, G: 75 } },
    { emoji: '🥬', name: 'Végétarienne', sizes: { P: 40, M: 45, G: 60 } },
    { emoji: '🍕', name: '4 Saisons', sizes: { P: 30, M: 55, G: 75 } },
    { emoji: '🧀', name: '4 Fromages', sizes: { P: 35, M: 45, G: 65 } },
    { emoji: '🍕', name: 'Mixte', sizes: { P: 40, M: 50, G: 65 } },
    { emoji: '🌾', name: 'Fermière', sizes: { P: 40, M: 50, G: 65 } },
    { emoji: '🥖', name: 'Yobo', sizes: { P: 40, M: 50, G: 70 } },
  ],
  pates: [
